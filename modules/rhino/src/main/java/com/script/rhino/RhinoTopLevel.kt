        ...
        fun bindings(
            ...
            if (args.size == 1) {
                ...
                if (arg is ExternalScriptable) {
                    ...
                    val top = ScriptableObject.getTopLevelScope(thisObj as VarScope)
                    return Context.javaToJS(bind, top)
                }
            }
        ...
        fun scope(cx: Context, thisObj: Scriptable?, args: Array<Any?>, funObj: Function?): Any {
            if (args.size == 1) {
                ...
                if (arg is Bindings) {
                    ...
                    res.prototype = ScriptableObject.getObjectPrototype(thisObj as VarScope)
                    res.parentScope = ScriptableObject.getTopLevelScope(thisObj as VarScope)
                    return res
                }
            }
            return Context.getUndefinedValue()
